const planetsData = {
    mercury: {
        ...
        temperature: '430°C',
        color: '#419EBB',
        gradient: 'linear-gradient(135deg, #419EBB 0%, #2D68F0 50%, #419EBB 100%)'
    },
    venus: {
        name: 'VENUS',
        ...
        temperature: '471°C',
        color: '#EDA249',
        gradient: 'linear-gradient(135deg, #EDA249 0%, #FFC649 50%, #EDA249 100%)'
    },
    earth: {
        name: 'EARTH',
        ...
        temperature: '16°C',
        color: '#6D2ED5',
        gradient: 'linear-gradient(135deg, #6D2ED5 0%, #545BDE 35%, #46C0E8 70%, #419EBB 100%)'
    },
    mars: {
        name: 'MARS',
        ...
        temperature: '-28°C',
        color: '#D14C32',
        gradient: 'linear-gradient(135deg, #D14C32 0%, #EC5E42 50%, #D14C32 100%)'
    },
    jupiter: {
        name: 'JUPITER',
        ...
        temperature: '-108°C',
        color: '#D83A34',
        gradient: 'linear-gradient(135deg, #D83A34 0%, #CD5120 30%, #ECAD7A 60%, #D83A34 100%)'
    },
    saturn: {
        name: 'SATURN',
        ...
        temperature: '-138°C',
        color: '#CD5120',
        gradient: 'linear-gradient(135deg, #CD5120 0%, #FCCB6B 50%, #CD5120 100%)'
    },
    uranus: {
        name: 'URANUS',
        ...
        temperature: '-195°C',
        color: '#1EC1A2',
        gradient: 'linear-gradient(135deg, #1EC1A2 0%, #65F0D5 50%, #1EC1A2 100%)'
    },
    neptune: {
        name: 'NEPTUNE',
        ...
        temperature: '-201°C',
        color: '#2D68F0',
        gradient: 'linear-gradient(135deg, #2D68F0 0%, #5B8FFF 50%, #2D68F0 100%)'
    }
};
